                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Add Pharmasist</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Add Pharmasist</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                               ...
                                               <div class="form-group row">
                                                ...
                                                <input class="form-control input-height" size="16" placeholder="date of Birth" type="date" value="">
