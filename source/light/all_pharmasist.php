                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Pharmasist List</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Pharmasist List</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-xs-6">
					                                            <div class="btn-group">
					                                                <a href="add_pharmasist.php" id="addRow" class="btn btn-info">
					                                    ...
					                                    <div class="table-scrollable">
					                                        ...
					                                        <tbody>
																...
																<tr class="odd gradeX">
																	...
																	<td	>
																		<a href="edit_pharmasist.php" class="btn btn-primary btn-xs">
				                                    ...
				                                    <div class="card-body no-padding ">
				                                    	<div class="doctor-profile">
					                                        ...
					                                        <div class="profile-userbuttons">
					                                            <a href="pharmasist_profile.php" class="btn btn-circle deepPink-bgcolor btn-sm">Read More</a>
					                                        </div>
				                                        </div>
				                                    </div>
				                                </div>
