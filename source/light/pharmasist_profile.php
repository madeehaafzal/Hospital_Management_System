                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">pharmasist Profile</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li><a class="parent-item" href="">Pharmasist</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li class="active">Pharmasist Profile</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <div class="card card-topline-aqua">
                                    <div class="card-body no-padding height-9">
                                        ...
                                        <div class="profile-userbuttons">
                                            <button type="button" class="btn btn-circle deepPink-bgcolor btn-sm">Follow</button>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body no-padding height-9">
                                        <div class="work-monitor work-progress">
                                            <div class="states">
                                                <div class="info">
                                                    <div class="desc pull-left">OPD</div>
                                            ...
                                            <div class="states">
                                                <div class="info">
                                                    <div class="desc pull-left">Patient visit</div>
					                            ...
					                            <div class="tab-content">
					                                <div class="tab-pane active fontawesome-demo" id="tab1">
															<div id="biography" >
							                                    ...
							                                    <p>And I was lucky to train in a collegial environment where we called most of our attendings by their first names.  If only doctors did it that way outside the Midwest.  One of my attendings even made the argument that it is safer for patient care because it’s easier for subordinates to raise concerns when they’re not verbally kowtowing to their superior.  I never respected a white-haired surgeon any less when I addressed him by his first name.  In fact, I saw that in non-clinical science, it is commonplace for the most junior researchers to call the most celebrated senior scientists by their first names.</p>
							                                    <p>When I offer or recommend products, I do so because I have actively researched them and find they are the best in that category for your health. I ignore substandard products, and products not directly pertinent to your health, regardless of any potential financial upsid</p>
							                                    <br>
